...
def getFandJ(v, efn, efp, params):
    ...
    for s in range(Nx*Ny):
        ...
        if 0 < i < Nx-1 and 0 < j < Ny-1:
            ...
            djy_s_defn_s, djy_s_defn_spN, djy_s_dv_s, djy_s_dv_spN = 0, 0, 0, 0#\
            ...
            djy_smN_defn_smN, djy_smN_defn_s, djy_smN_dv_smN, djy_smN_dv_s = 0,0,0,0#\
            ...
            djy_s_defp_s, djy_s_defp_spN, djy_s_dv_s, djy_s_dv_spN = 0,0,0,0#\
            ...
            djy_smN_defp_smN, djy_smN_defp_s, djy_smN_dv_smN, djy_smN_dv_s = 0,0,0,0# \
            ...
            dfv_dv = 2./(dx_i * dx_im1) + exp(bl-eg+efp_s-v_s) + exp(-bl+efn_s+v_s)
        ...
        # right boundary
            ...
            jny_s = 0#mu_s * get_jn(efn_s, efn_spN, v_s, v_spN, dy_j, params)
            jny_smN = 0#mu_smN * get_jn(efn_smN, efn_s, v_smN, v_s, dy_jm1, params)
            jnx_s = jnx_sm1 + dxbar * (r - g[s] - (jny_s - jny_smN)/dybar)

            jpx_sm1 = mu_sm1 * get_jp(efp_sm1, efp_s, v_sm1, v_s, dx_im1, params)
            jpy_s = 0#mu_s * get_jp(efp_s, efp_spN, v_s, v_spN, dy_j, params)
            jpy_smN = 0#mu_smN * get_jp(efp_smN, efp_s, v_smN, v_s, dy_j, params)
            ...
            djny_s_defn_s, djny_s_defn_spN, djny_s_dv_s, djny_s_dv_spN = 0,0,0,0#\
            # get_jn_derivs(efn_s, efn_spN, v_s, v_spN, dy_j, params)

            djny_smN_defn_smN, djny_smN_defn_s, djny_smN_dv_smN, djny_smN_dv_s = 0,0,0,0#\
            # get_jn_derivs(efn_smN, efn_s, v_smN, v_s, dy_jm1, params)
            ...
            djpy_s_defp_s, djpy_s_defp_spN, djpy_s_dv_s, djpy_s_dv_spN = 0,0,0,0#\
            # get_jp_derivs(efp_s, efp_spN, v_s, v_spN, dy_j, params)

            djpy_smN_defp_smN, djpy_smN_defp_s, djpy_smN_dv_smN, djpy_smN_dv_s = 0,0,0,0#\
            # get_jp_derivs(efp_smN, efp_s, v_smN, v_s, dy_jm1, params)
